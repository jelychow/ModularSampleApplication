...
public class ToastCompatFor7 extends Toast{

    private static final String TAG = "ToastCompatFor7";

    public ToastCompatFor7(Context context) {
        super(context);
    }
     ...
     *
     */
    public static ToastCompatFor7 makeText(Context context, CharSequence text,int duration) {
        ToastCompatFor7 result = new ToastCompatFor7(context);
